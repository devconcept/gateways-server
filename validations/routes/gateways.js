...
module.exports = {
  getAllGatewaysValidation: [
    query('page')
      ...
      .not()
      .exists()
      .withMessage('Only one of page or next must be provided'),
    query('size')
      .optional({ nullable: false, checkFalsy: false })
